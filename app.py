...
if authentication_status:
    ...
    # Get user inputs
    country = st.selectbox("Country Of Origin", options=country_options)
    gender = st.selectbox("Gender", options=gender_options)
    age = st.selectbox("Age", options=age_options)
    marital_status = st.selectbox("Marital Status", options=marital_options)
    prev_count_cred = st.selectbox("Did your previous country have a credit system ", options=prev_cred_options)
    US_Duration_ = st.selectbox("Duration of stay in the U.S", options=US_Duration)
    ...
    Time_InUS_ = st.selectbox("Duration of stay in the U.S", options=Time_InUS)
    Credit_ = st.selectbox("Credit score", options=Credit)
    Loan_Amount_ = st.selectbox("Loan amount", options=Loan_Amount)
